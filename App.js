...
import SignInScreen from '../baigiauki/SignInScreen'; // Import màn hình SignIn
...
const OnboardingScreen = ({ navigation }) => {
  return (
    <ImageBackground
      source={require('../baigiauki/assets/tho.png')} // Hình nền của bạn
      style={styles.background}
    >
      <View style={styles.overlay}>
        {/* Khu vực chứa logo, tiêu đề, phụ đề và nút */}
        <View style={styles.content}>
          <Image source={require('../baigiauki/assets/carot.jpg')} style={styles.logo} />
